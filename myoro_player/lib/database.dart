...
class Database {
  ...
  static Future<int> insert(String table, Map<String, dynamic> data) async => await _database.insert(table, data);

  static Future<void> update(String table, Map<String, dynamic> data, [Map<String, dynamic>? conditions]) async {
    conditions = formatConditions(conditions);
